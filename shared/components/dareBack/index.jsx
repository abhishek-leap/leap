...
import { closeDareBackBottomDrawer, openDareBackSecondStepBottomDrawer } from '../../redux-ui-state/slices/dareBackSlice';
import { selectedVedioURI, vedioThumbnail } from '../../redux-ui-state/slices/createDareSlice';

const DareBack = ({onCloseIconClick, selectedPostItem}) => {
    const {colors} = useTheme();
    const dispatch = useDispatch();
    const { status, data, error, isLoading, refetch, fetchNextPage } = useDareBackInfiniteFeeds()
    ...
    return (
        ...
        <>
          ...
          <Footer 
            callBackFooterFunction={callBackFooterFunction}
          />
        </>
        }
      </>
